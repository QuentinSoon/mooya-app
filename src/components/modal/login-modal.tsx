...
import { Modal, ModalProps } from '@/library/modal';
import { HandleSignWithGoogle } from '@/utils/supabase/supabase';
import Image from 'next/image';

export const ModalLogin = ({ open, setOpen }: ModalProps) => {
	return (
		<Modal open={open} setOpen={setOpen} className="w-96">
			...
			<div className="relative p-4 flex flex-col gap-4">
				...
				<div className="flex flex-col gap-2">
					<Input variant="floating" placeholder="Entrez votre adresse email" />
